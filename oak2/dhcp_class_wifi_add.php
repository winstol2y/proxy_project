<?php
	...
	//{
		//$query_add = "INSERT INTO `dhcp`.`class_wifi` (`wifi_id`, `name`, `surname`, `id-card`,`email`,`mac`,`ip`,`iplong`,`tel`,regis_time,) VALUES (NULL,'".$_POST["name"]."','".$_POST["surName"]."','".$_POST["people_id"]."','".$_POST["email"]."','".$_POST["mac"]."','".$_POST["tel"]."','".$dat."')";
		...
		//mysql_close($con);
		//header('Location: dhcp_class_wifi.php');
	//}
?>