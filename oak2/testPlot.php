...
<head>
    ...
    <link class="include" rel="stylesheet" type="text/css" href="./dist/jqplot/jquery.jqplot.min.css" />
    <link rel="stylesheet" type="text/css" href="examples.min.css" />
    <link type="text/css" rel="stylesheet" href="./dist/jqplot/syntaxhighlighter/styles/shCoreDefault.min.css" />
    <link type="text/css" rel="stylesheet" href="./dist/jqplot/syntaxhighlighter/styles/shThemejqPlot.min.css" />
  
  <!--[if lt IE 9]><script language="javascript" type="text/javascript" src="../excanvas.js"></script><![endif]-->
    <script class="include" type="text/javascript" src="./dist/jqplot/jquery.min.js"></script>
...
<!-- Example scripts go here -->
    <link class="include" rel="stylesheet" type="text/css" href="./dist/jqplot/jquery-ui/css/smoothness/jquery-ui.css" />
...
<!-- Don't touch this! -->
    ...
    <script class="include" type="text/javascript" src="./dist/jqplot/jquery.jqplot.min.js"></script>
    <script type="text/javascript" src="./dist/jqplotsyntaxhighlighter/scripts/shCore.min.js"></script>
    <script type="text/javascript" src="./dist/jqplotsyntaxhighlighter/scripts/shBrushJScript.min.js"></script>
    <script type="text/javascript" src="./dist/jqplotsyntaxhighlighter/scripts/shBrushXml.min.js"></script>
<!-- End Don't touch this! -->

<!-- Additional plugins go here -->
    <script class="include" type="text/javascript" src="./dist/jqplot/plugins/jqplot.dateAxisRenderer.min.js"></script>
    <script class="include" type="text/javascript" src="./dist/jqplot/plugins/jqplot.logAxisRenderer.min.js"></script>
    <script class="include" type="text/javascript" src="./dist/jqplot/plugins/jqplot.canvasTextRenderer.min.js"></script>
    <script class="include" type="text/javascript" src="./dist/jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js"></script>
    <script class="include" type="text/javascript" src="./dist/jqplot/plugins/jqplot.highlighter.min.js"></script>
