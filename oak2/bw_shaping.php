                  ...
                  <form action="add_bw_shaping.php" method="post" name="frm_data">
                    ...
                    <div class="row">
                      <div class="col-sm-2 col-sm-offset-3">
                        <h4 align="right">Number of Pool :</h4> 
                      </div>
                      <div class="col-sm-3">
                        <input class="form-control" name="class_num" type="text" placeholder="1 - 100"/>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="class_num" type="text" placeholder="1 -5"/>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_begin" type="text" placeholder="Ex. : 10.0.0.2 "/>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_end" type="text" placeholder="Ex. : 10.9.255.254 "/>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <table>
                          <tr>
                            <td>
                              <input class="form-control" name="bw_class" type="text" placeholder="Ex. :  64000"/>
                            </td>
                            <td>
                              <p> KB/s</p>
                            </td>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <table>
                          <tr>
                            <td>
                              <input class="form-control" name="bw_client" type="text" placeholder="Ex. :  64000"/>
                            </td>
                            <td>
                              <p> KB/s</p>
                            </td>
