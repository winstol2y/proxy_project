<?php
	...
	{
		echo '<script type="text/javascript">window.location.href = "./dhcp_class2.php";</script>';
	}
	...
	else
	{
		...
		while (($objArr = fgetcsv($objCSV, 1000, ",")) !== FALSE) 
		{
			...
			$ip_query = "SELECT * FROM `class2` WHERE `ip` = '".$result_ip."'";
			...
			{
				$strSQL = "INSERT INTO `dhcp`.`class2` (hw,name,ip,expire) VALUES ('$objArr[0]','$objArr[1]','$objArr[2]','$objArr[3]')";
