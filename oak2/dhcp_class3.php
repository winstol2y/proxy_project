            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_dhcp_class3.php" method="post" name="frm_data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_add" type="text" placeholder="10.21.0.2 - 10.30.255.254"/>
                      </div>
                    </div>
                  ...
                  <form action="upload_csv_class3.php" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table">
                            ...
                            <?php
                              ...
                              while($my_row1=mysql_fetch_array($my_result))
                              {
                                ...
                                table('<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=/oak2/deleteDB/delete_dhcp3.php?ip='.trim($my_row1["ip"]).'&mac='.trim($my_row1["hw"]).'>Delete</button>');
                                $i++;
                                echo '</tr>';
                              }
                            ?>
