            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="dhcp_class4_add.php" method="post" name="frm_data">
                  ...
                  <form action="dhcp_class4_upload_csv.php" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table table-striped">
                            ...
                            <?php
                              ...
                              while($my_row1=mysql_fetch_array($my_result))
                              {
                                ...
                                table('<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=/oak2/dhcp_class4_delete.php?mac='.trim($my_row1["hw"]).'>Delete</button>');
                                $i++;
                                echo '</tr>';
                              }
                            ?>
