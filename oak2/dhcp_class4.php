<?php
  ...
  $query_all_data = 'SELECT * FROM `class4`';
...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Proxy Web UI:DHCP Class 4</title>
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_dhcp_class4.php" method="post" name="frm_data">
                    
                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">DHCP Class 4</h1> 
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_add" type="text" placeholder="10.31.0.2 - 10.40.255.254"/>
                      </div>
                    </div>
                  ...
                  <form action="upload_csv_class4.php" method="post" enctype="multipart/form-data">
                          ...
                          <table class="table">
                            ...
                            <?php
                              ...
                              while($my_row1=mysql_fetch_array($my_result))
                              {
                                ...
                                table('<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=/oak2/deleteDB/delete_dhcp4.php?ip='.trim($my_row1["ip"]).'&mac='.trim($my_row1["hw"]).'>Delete</button>');
                                $i++;
                                echo '</tr>';
                              }
                            ?>
