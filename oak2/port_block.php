...
<?php
  ...
  $query_all_data = 'SELECT * FROM `block_port` ORDER BY id DESC';
...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Proxy Web UI:Block Port</title>
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_port_block.php" method="post" name="frm_data">
                    
                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">Block Port</h1> 
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-2 col-sm-offset-3">
                        <h4 align="right">Port :</h4> 
                      </div>
                      <div class="col-sm-3">
                        <input class="form-control" name="port_add" type="text" placeholder="Ex. : 80 8080 "/>
                      </div>
                    </div>
                          ...
                          <table class="table table-striped">
                            ...
                            <?php
                              ...
                              while($my_row1=mysql_fetch_array($my_result))
                              {
                                ...
                                table($my_row1["time"]);
                                table($my_row1["day"]);
                                table('<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=/oak2/delete_port_block.php?id='.trim($my_row1["id"]).'>Delete</button>');
                                $i++;
                                echo '</tr>';
                              }
                            ?>
