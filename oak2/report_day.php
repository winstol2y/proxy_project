...
<?php
  ...
  for($count = 0; $count < count($duplicateUrl); $count++)
  {
    ...
    $selectCountUrl  = 'SELECT count(url),sum(byte),sum(timeUse) FROM `'.$table.'` WHERE `url` LIKE "%'.$duplicateUrl["$count"].'%"';
    ...
    while($countUrl = mysql_fetch_assoc($queryCountUrl)){
      ...
      $selectCountIp  = 'SELECT DISTINCT ipClient FROM `'.$table.'` WHERE `url` LIKE "%'.$duplicateUrl["$count"].'%"';
                          ...
                          <table class="table table-striped">
                            ...
                            <?php
                              ...
                              { 
                                echo "<tr>";
                                  echo "<td><b>".$x."</b></td>";
                                  echo "<td><a href=report_day_ip.php?ip=".$ipC_Arr[$i]."&table=".$table.">".$ipC_Arr[$i]."</a></td>";
