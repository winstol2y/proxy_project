...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/dt/jquery.dataTables.css">
    <script type="text/javascript" charset="utf-8" src="./js/dt/jquery.js"></script>
    <script type="text/javascript" charset="utf-8"src="./js/dt/jquery.dataTables.js"></script>
                    ...
                    <div class="col-sm-12">
                      ...
                      <table id="example"  class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $my_row1["name"]; ?></td>
                            <td><?php echo $my_row1["url"]; ?></td>
                            <td><?php echo $my_row1["time"]; ?></td>
                            <td><?php echo $my_row1["day"]; ?></td>
                            <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="/oak2/delete_url.php?id="<?php echo trim($my_row1["id"]); ?>>Delete</button></td>
                          </tr>
                          <?php   
                            }
                            mysql_close($con);
