...
<?php
  ...
  $query_all_data = 'SELECT * FROM `block_keyword` ORDER BY id DESC';
...
<html lang="en">
  ...
  <head>
    ...
    <title>Proxy Web UI:Keyword Block</title>
    <style type="text/css">
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_key.php" method="post" name="frm_data">

                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">Block Keyword</h1> 
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-2 col-sm-offset-3">
                        <h4 align="right">Keyword :</h4> 
                      </div>
                      <div class="col-sm-3">
                        <input class="form-control" name="key_add" type="text" placeholder="Ex. : Sex Porn "/>
                      </div>
                    </div>
                            ...
                            <?php
                              ...
                              while($my_row1=mysql_fetch_array($my_result))
                              {
                                echo '<tr>';
                                  table("$i");
                                  table($my_row1["name"]);
                                  table($my_row1["keyword"]);
                                  table($my_row1["time"]);
                                  table($my_row1["day"]);
                                  table('<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever=/oak2/delete_key.php?id='.trim($my_row1["id"]).'>Delete</button>');                                  $i++;
                                echo '</tr>';
                              }
                            mysql_close($con);
                            ?>
