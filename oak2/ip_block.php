...
<?php
  ...
  $query_all_data = 'SELECT * FROM `block_ip` ORDER BY id DESC';
...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Proxy Web UI:Block IP</title>
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_ip_block.php" method="post" name="frm_data">
                    
                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">Block IP</h1> 
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-2 col-sm-offset-3">
                        <h4 align="right">IP :</h4> 
                      </div>
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_add" type="text" placeholder="Ex. : 8.8.8.8 "/>
                      </div>
                    </div>
