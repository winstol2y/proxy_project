...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Proxy Web UI:User Class 1</title>
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="dhcp_class1_add.php" method="post" name="frm_data">
                    
                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">User Class 1</h1> 
                      </div>
                    </div>
                  ...
                  <form action="dhcp_class1_upload_csv.php" method="post" enctype="multipart/form-data">
