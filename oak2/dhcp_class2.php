...
<html lang="en">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Proxy Web UI:DHCP Class 2</title>
            ...
            <div class="padding">
              <div class="full col-sm-12">
                <div class="row"><!-- Content -->
                  <form action="add_dhcp_class2.php" method="post" name="frm_data">
                    
                    <div class="row">
                      <div class="col-sm-12">
                        <h1 align="center">DHCP Class 2</h1> 
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="ip_add" type="text" placeholder="10.11.0.2 - 10.20.255.254"/>
                      </div>
                    </div>
                  ...
                  <form action="upload_csv_class2.php" method="post" enctype="multipart/form-data">
