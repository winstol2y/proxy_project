...
เลือกจำนวนล็อกไฟล์ที่ต้องการอัพโหลด
<form name="jump1">
    <select name="myjumpbox" OnChange="location.href=jump1.myjumpbox.options[selectedIndex].value">
        <option value="http://localhost/coope/index.php/account_all/view_report" <?php if($_SERVER['REQUEST_URI'] == '/coope/index.php/account_all/view_report'){ echo 'selected'; } ?>> ----- เลือก -------</option>
