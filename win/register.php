...
<div class="testbox">
  ...
  <form action="/">
    ...
    <div class="accounttype">
      ...
      <label for="radioOne" class="radio" chec>บุคลากร</label>
      <input type="radio" value="None" id="radioTwo" name="account" />
      <label for="radioTwo" class="radio">ผู้ใช้งานทั่วไป</label>
    </div>
  <hr>
  <label id="icon" for="surName"><i class="icon-user"></i></label>
  ...
  <input type="text" name="lastName" id="lastName" placeholder="นามสกุล" required/>
    ...
    <label id="icon" for="people_id"><i class="icon-envelope "></i></label>
  <input type="text" name="people_id" id="people_id" placeholder="เลขประจำตัวประชาชน" required/>
    
  <label id="icon" for="name"><i class="icon-user"></i></label>
  <input type="text" name="name" id="name" placeholder="E-Mail (ถ้ามี)"/>
